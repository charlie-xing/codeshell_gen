...
M.exec = function(options)
    ...
    if string.find(cmd, "%$body") then
        ...
        if string.find(opts.model,"codeshell") then
            ...
            -- local json = string.format('{"prompt":"%s","n_predict":%d,"temperature:",%.2f,"top_k:",%d,"stream":true}',body.prompt,body.n_predict,body.temperature,body.top_k)
